        ...
        msignup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mail.isEmpty()||password.isEmpty()){
                    ...
                    Toast.makeText(getApplicationContext(),"Password Length Should be Greater than 7 Digits",Toast.LENGTH_SHORT).show();
                    ...
                    firebaseAuth.createUserWithEmailAndPassword(mail,password).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (task.isSuccessful()){
                                ...
                                Toast.makeText(getApplicationContext(),"Something Went Wrong, Try Again After Some Time",Toast.LENGTH_SHORT).show();
